...
Observe
\begin{IEEEeqnarray*}{rCl}
  \abs{\nu}^2 &=& \frac{\mathcal{R}^2(r, u)}{\mathcal{R}^2(\sqrt{2}r, u)} + \frac{r^2}{4 \mathcal{R}^2(r, u) \mathcal{R}^2(\sqrt{2}r, u)} \parens{ \abs{u}^2 + 4r^2 - 4r \parens{u \cdot a} } \\
  &=& \frac{\mathcal{R}^2(r, u)}{\mathcal{R}^2(\sqrt{2}r, u)} + \frac{r^2}{4 \mathcal{R}^2(r, u) \mathcal{R}^2(\sqrt{2}r, u)} \parens{ \abs{u}^2 + 4r^2 - 4r \frac{\abs{u}^2}{2r} } \\
  &=& \frac{\mathcal{R}^2(r, u)}{\mathcal{R}^2(\sqrt{2}r, u)} + \frac{r^2}{4\mathcal{R}^2(r, u) \mathcal{R}^2(\sqrt{2}r, u)} \parens{4r^2 - \abs{u}^2} \\
  &=& \frac{\mathcal{R}^2(r, u)}{\mathcal{R}^2(\sqrt{2}r, u)} + \frac{r^2}{\mathcal{R}^2(\sqrt{2}r, u)} = 1,
\end{IEEEeqnarray*}
...
\subsubsection{Simplifying Computation}%;
Put $\mathcal{D}(u, r) = \phi^{-1}(\{r\}), \, \mathcal{R}(u) = \phi(\mathcal{D}(u))$ so that
...
\begin{IEEEeqnarray*}{ll}
  ...
  &= \int_{\mathbb{R}^2} \int_{\mathcal{R}(u)} \int_{\mathcal{D}(u, r)} \frac{\parens{g(a, b, r) \cdot n} \abs{\sproj b^\perp}}{2\sqrt{2} \abs{\parens{p \cdot a}\parens{p \cdot c}} r^2 \sqrt{2 \parens{p \cdot c}^2 + \parens{p \cdot a}^2}}
  \, d\mathcal{H}^{2n-5}(a, b) dr d\mathcal{H}^2(u)
\end{IEEEeqnarray*}
In order to simplify this, recall
$$
