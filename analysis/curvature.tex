...
Next, since $\mathcal{B}(u, r) = \mathcal{U}\parens{\braces{u}^\perp}$, we know $\mathcal{B}(u, r)$ is a unit sphere of dimension $n-2$. Notably, if $b \in \mathcal{B}(u, r)$ then
%$$
%  \mathcal{P}_S b^\perp = \parens{\parens{b \cdot u}u + \parens{b \cdot u^\perp}u^\perp}^\perp = -\parens{b \cdot u^\perp}u \implies \abs{\sproj b^\perp} = \abs{b \cdot u^\perp} = \abs{\sproj b \cdot u^\perp}
%$$
%
%$$
%\frac{\sproj b^\perp}{\abs{\sproj b^\perp}} = \frac{u}{\abs{u}} \implies \frac{\sproj b^\perp \cdot \sproj b^\perp}{\abs{\sproj b^\perp}} = \frac{u \cdot \sproj b^\perp}{\abs{u}}
%$$
%
%$$
%\abs{\sproj b^\perp} = \frac{1}{\abs{u}} u \cdot \sproj b^\perp = -\frac{1}{\abs{u}} u^\perp \cdot \sproj b
%$$
%
%Putting this back into our top-level integral gives us
%\begin{IEEEeqnarray*}{ll}
...
%Our computation simplifies to
%$$
%\kappa_\sigma \cdot n = \frac{-\pi}{4\sqrt{2}} \int_{\mathbb{R}^2} \chi(u) \int_{\phi(\mathcal{D}(u))} \frac{1}{r^{2+\sigma}\sqrt{r^2 - \frac{\abs{u}^2}{4}}} \, dr \, d\mathcal{H}^2(u) = \frac{-\pi}{4\sqrt{2}} \int_{\mathbb{R}^2} \chi(u) \int_{\abs{u}/2}^\infty \frac{1}{r^{2+\sigma}\sqrt{r^2 - \frac{\abs{u}^2}{4}}} \, dr \, d\mathcal{H}^2(u).
%$$
%Substitute $r = \frac{\abs{u}}{2} s^{-1/2}$ so that $r \to \abs{u}/2 \implies s \to 1, \, r \to \infty \implies s \to 0, \, dr = \frac{-\abs{u}}{4} s^{-3/2} ds$ and
%\begin{IEEEeqnarray*}{rCl}
%  \kappa_\sigma \cdot n &=& \frac{\pi}{4\sqrt{2}} \int_{\mathbb{R}^2} \chi(u) \int_1^0
