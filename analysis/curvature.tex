...
\frac{
  ...
  \implies \kappa_\sigma \cdot n &=& -\pi 2^{1+\sigma-5/2} B\parens{\frac{\sigma + 2}{2}, \frac{1}{2}} \int_{\mathbb{R}^2} \frac{\chi(u)}{\abs{u}^{2+\sigma}} \, d\haus{2}{u}.
\end{IEEEeqnarray*}
...
\end{IEEEeqnarray*}
where $\omega_{n-1} = \frac{2\pi^{n/2}}{\Gamma(n/2)}$ is the surface area of a unit ball in $\mathbb{R}^n$. Putting this back into our top-level integral gives us
\begin{IEEEeqnarray*}{ll}
  \frac{-1}{2\sqrt{2}} \int_{\mathbb{R}^2} & \chi(u) \int_{\phi(\mathcal{D}(u))} \frac{1}{r^{2+\sigma} \mathcal{R}(u, r) } \int_{\mathcal{B}(u)} \abs{\sproj b^\perp}^2
  \int_{\mathcal{A}(u, r, b)} \, d \haus{n-3}{a} \, d \haus{n-2}{b} \, dr \, d \haus{2}{u} \\
  &= \frac{-1}{2\sqrt{2}} \int_{\mathbb{R}^2} \chi(u) \int_{\phi(\mathcal{D}(u))} \frac{1}{r^{2+\sigma} \mathcal{R}(u, r) } \int_{\mathcal{B}(u)} \abs{\sproj b^\perp}^2 
...
\begin{IEEEeqnarray*}{rCl}
  ...
  \int_{-1}^1 \abs{v}^2 \int_{\zeta^{-1}\parens{\braces{v}}} \frac{1}{\sqrt{1-v^2}}\, d\haus{n-3}{x} \, dv \\
  &=&
  \int_{-1}^1 \abs{v}^2 \parens{1-v^2}^{-1/2} \int_{\zeta^{-1}\parens{\braces{v}}} \, d\haus{n-3}{x} \, dv \\
  &=&
  \omega_{n-3} \int_{-1}^1 v^2 \parens{1-v^2}^{(n-4)/2} \, dv \\
  &=&
  2\omega_{n-3} \int_{0}^1 v^2 \parens{1-v^2}^{(n-4)/2} \, dv \\
  &=&
  \omega_{n-3} \int_{0}^1 v^{1/2} \parens{1-v}^{(n-4)/2} \, dv = \omega_{n-3} B\parens{\frac{3}{2}, \frac{n-2}{2}},
\end{IEEEeqnarray*}
